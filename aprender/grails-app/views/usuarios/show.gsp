...
<html>
    ...
    <body>
        ...
        <div id="show-usuarios" class="content scaffold-show" role="main">
            ...
            <f:display bean="usuarios" />
            <g:form resource="${this.usuarios}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usuarios}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
